...
//<li className="txt skills"><a>Skills</a></li> '../src/img/me.png' <PostCard post={post} />
        ...
        <div className="main">
          <nav>
            <ul className="nav-menu">
              <li id="home" className="txt hm hover active"><a>Home</a></li>
              <li className="txt proj"><a>Projects</a></li>
              <li className="txt about"><a>About</a></li>
            </ul>
          </nav>
          ...
          <div id="projPage" className="projPage hidden">
            ...
            <p className="projItem hovertxt">
              ...
              <a>Djarvis is a small console project that is meant to be a development-orientated version of Iron Man's Jarvis program. Djarvis starts on a loop, listening until it hears the word "open". After the word has been said, the program asks what you want to do, gets the information regarding what you want to do and thereafter opens the pre-designated programs. For example, when I want to work on web development, Djarvis opens vsCode and my web browser.</a>
            </p>
            <p className="projItem hovertxt">
              ...
              <a>A connect 4 game that is written in Python3 where you play against an AI that is written using the MiniMax algorithm.</a>
            </p>
            <p className="projItem hovertxt">
              <a className="stxt" href="https://github.com/Cornelius27584046/unity3D-Arena-Game"><GithubOutlined /> Unity 3D Arena Game
                 </a><br/>
              <a>Small but cool 3D game written by following a tutorial by AwesomeTuts.</a>
            </p>
            ...
            <p className="projItem">
              <a className="stxt"> name: to be decided</a><br/>
              <a>Unity 3D Endless runner game where you play as a slime. In the beginning all you can do is dodge, but as you level up you will start learning how to attack.</a>
            </p>
            <p className="projItem">
              <a className="stxt"> name: to be decided</a><br/>
              <a>
